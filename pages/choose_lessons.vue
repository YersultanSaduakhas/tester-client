  ...
  <v-card max-width="600" class="mx-auto">
    ...
    <v-list subheader two-line>
      ...
      <v-list-item v-for="mainSubject in mainSubjects" :key="mainSubject.title">
        ...
        <v-list-item-content>
          <v-list-item-title v-text="mainSubject.title" />
      ...
      <v-list-item v-for="(additionalSubject,ind) in selectedAdditionalSubjects" :key="additionalSubject.title">
        <v-list-item-avatar>
          <v-icon :class="additionalSubject.color" dark v-text="additionalSubject.icon" />
        </v-list-item-avatar>

        <v-list-item-content>
          <v-list-item-title v-text="additionalSubject.id===-1 ? $t('not_choosen') : additionalSubject.title" />

          <v-list-item-subtitle v-text="additionalSubject.id===-1 ? '' : $t('total_question_count') + ' ' + additionalSubject.questions_count" />
        </v-list-item-content>
